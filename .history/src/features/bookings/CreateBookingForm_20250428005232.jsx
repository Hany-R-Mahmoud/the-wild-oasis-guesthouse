...
import { differenceInDays, isDate, startOfToday } from "date-fns";
...
function CreateBookingForm({ onCloseModal }) {
  ...
  const {settings, isLoading:isLoadingettings} = useSettings
  // console.log(cabins);
  ...
  function onSubmit(data) {
    ...
    const numNights = differenceInDays(new Date(date.endDate), new Date(date.startDate));
