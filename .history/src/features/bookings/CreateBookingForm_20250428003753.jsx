...
function CreateBookingForm({ onCloseModal }) {
  ...
  const { createGuest, isCreatingGuest, data: guestData } = useCreateGuest();
  ...
  return (
    <>
      ...
      {isGuestForm ? (
        ...
        <>
          <Guest>
            {/* {guestData?.countryFlag && (
              <Flag
                src={guestData?.countryFlag}
                alt={`Flag of ${guestData?.nationality}`}
              />
            )}
            <p>
              {guestData?.fullName}
            ...
            <p>{guestData?.email}</p>
            <span>&bull;</span>
            <p>National ID {guestData?.nationalID}</p> */}
            <h2>Guest Details</h2>
            <p>Name: {guestData.fullName}</p>
            <p>Email: {guestData.email}</p>
            <p>National ID: {guestData.nationalID}</p>
            <p>Nationality: {guestData.nationality}</p>
          </Guest>
