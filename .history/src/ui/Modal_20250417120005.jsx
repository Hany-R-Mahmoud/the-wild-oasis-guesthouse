...
function Window({ children, name }) {
  ...
  useEffect(function () {
    ...
    // when events bubble up, it will affect the modal at the end ( so any clicking , will be listened as clicking outside the modal => close the modal)
...
// 4) add child comp to parent as property
Modal.Open = Open;
Modal.Window = Window;
